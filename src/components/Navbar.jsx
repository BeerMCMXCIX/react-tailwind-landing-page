...
function Navbar() {
  ...
  return (
    <nav className='bg-[#F5F7FA]'>
        <div className="container mx-auto max-w-[1440px] relative h-auto p-10 flex flex-col md:flex-row md:justify-between md:items-center md:h-[84px]">
            <div>
                <a href="#">
                    <img src={Logo} alt="" />
                </a>
            ...
            <ul className={`${!toggle ? 'hidden' : 'flex'} flex flex-col md:my-5 md:flex md:flex-row`}>
