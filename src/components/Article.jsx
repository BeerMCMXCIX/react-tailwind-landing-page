            ...
            <div className='mt-4 mb-21'>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                    <div className='relative my-8 md:m-0'>
                        <img className='rounded-xl md:max-w-[368px] mx-auto p-0' src={articleImg01} alt="" />
                    ...
                    <div className='relative my-8 md:m-0'>
                        <img className='rounded-xl md:max-w-[368px] mx-auto p-0' src={articleImg02} alt="" />
                    ...
                    <div className='relative my-8 md:m-0'>
                        <img className='rounded-xl md:max-w-[368px] mx-auto p-0' src={articleImg03} alt="" />
