...
function Stats() {
  return (
    <div className='bg-[#F5F7FA] py-10 px-5 md:px-0'>
        <div className='container mx-auto max-w-[1440px] grid grid-cols-1 md:grid-cols-2 items-center'>
            <div>
                <h3 className='text-[36px] text-[#4D4D4D] font-semibold leading-[1]'>Helping a local <br /> <span className='text-[#4CAF4F]'>business reinvent itself</span></h3>
                <p className='text-[16px] mt-2'>We reached here with our hard work and dedication</p>
            </div>
            ...
            <div>
                <div className='grid grid-cols-1 md:grid-cols-2 text-center md:text-left'>
                    <div className='flex flex-col md:flex-row items-center'>
                        ...
                        <div>
                            <h3 className='text-[28px] text-[#4D4D4D] font-bold'>2,245,341</h3>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        ...
                        <div>
                            <h3 className='text-[28px] text-[#4D4D4D] font-bold'>46,328</h3>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        ...
                        <div>
                            <h3 className='text-[28px] text-[#4D4D4D] font-bold'>828,867</h3>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        ...
                        <div>
                            <h3 className='text-[28px] text-[#4D4D4D] font-bold'>1,926,436</h3>
